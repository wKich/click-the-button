...
Note: Подключимся по вебсокетам к браузеру из самого браузера, чтобы управлять этим браузером из браузера.

---

![](./xzibit.jpg)

Note: У нас может быть открыто много вкладок и чтобы выяснить с какой вкладкой нам необходимо работать, нужно применить немного консольной магии
...
Note: Для этого подпишемся на события консоли для каждой вкладки. После сгенерируем гуид и выведем его в консоль. Нам нужна та вкладка в которой сообщение в консоли будет равно нашему гуиду. Всё это дает возможность использовать puppeteer в наших браузерных тестах. Напишем сам тест.
